...
$(document).ready(function() {
  ...
  // create variables for the random numbers associated with each object
  ...
  //create click function for the objects
  //random number on object added to user total
  //set win/loss condition
  //do for each object variable
